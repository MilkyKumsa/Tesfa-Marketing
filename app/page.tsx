...
export default function Home() {
  return (
    <main className="min-h-screen bg-gray-900 text-white scroll-smooth">
      ...
      {/* Hero Section */}
      <section id="home" className="relative pt-32 pb-24 px-4 bg-gradient-to-b from-gray-950 via-gray-900 to-gray-800 overflow-hidden">
        {/* Fixed Navigation */}
        {/* Fixed Navigation */}
<header className="fixed top-0 left-0 right-0 bg-gray-900/95 backdrop-blur-lg shadow-2xl z-50 border-b border-amber-400/20">
  <div className="container mx-auto px-6 py-5 flex justify-between items-center">
    {/* Logo Replacement */}
    <a href="#home" className="h-12 w-64 relative block"> {/* Increased width for better fit */}
      <Image
        src="https://cdn.vectorstock.com/i/1000v/57/84/digital-marketing-logo-vector-46455784.jpg"
    ...
    <button className="md:hidden text-3xl text-amber-400">☰</button>
        ...
        <div className="container mx-auto max-w-6xl text-center mt-10">
          <h2 className="text-5xl md:text-7xl font-extrabold mb-8 leading-tight">
            ...
            <span className="text-amber-400">Creative Digital Excellence</span>
          </h2>
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            Full-service digital marketing agency delivering measurable results through strategy, creativity, and innovation.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a href="#contact" className="bg-amber-400 text-gray-900 px-12 py-6 rounded-full font-bold text-lg hover:bg-amber-300 transition shadow-2xl transform hover:scale-105">
              Start Your Project
            </a>
            <a href="#services" className="border-2 border-amber-400 text-amber-400 px-12 py-6 rounded-full font-bold text-lg hover:bg-amber-400 hover:text-gray-900 transition">
              Explore Services
            </a>
          </div>
        </div>
      ...
      {/* Testimonials Section - With Portraits */}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-7xl mx-auto">
            ...
            <div className="bg-gray-900/90 p-8 rounded-2xl border border-amber-400/20 hover:border-amber-400/60 hover:shadow-2xl hover:-translate-y-4 transition-all duration-500 text-center">
              <Image
                src="https://st3.depositphotos.com/1000816/17973/i/450/depositphotos_179733424-stock-photo-portrait-of-an-african-american.jpg"
                alt="Michael Abebe"
                width={400}
                height={400}
                className="w-28 h-28 rounded-full mx-auto mb-6 object-cover border-4 border-amber-400/50"
              />
              ...
              <p className="text-gray-300 italic mb-6">
                "Tesfa Marketing completely transformed our brand identity and digital presence. Their creativity and strategic approach delivered exceptional results."
              </p>
            ...
            <div className="bg-gray-900/90 p-8 rounded-2xl border border-amber-400/20 hover:border-amber-400/60 hover:shadow-2xl hover:-translate-y-4 transition-all duration-500 text-center">
              <Image
                src="https://thumbs.dreamstime.com/b/portrait-business-woman-office-confidence-leader-space-public-relations-happy-empowerment-portrait-business-402757398.jpg"
                alt="Helen Getachew"
                width={400}
                height={400}
                className="w-28 h-28 rounded-full mx-auto mb-6 object-cover border-4 border-amber-400/50"
              ...
              <p className="text-gray-300 italic mb-6">
                "Top-notch digital campaigns and outstanding customer service. Our ROI has never been better thanks to their expertise."
              </p>
            ...
            <div className="bg-gray-900/90 p-8 rounded-2xl border border-amber-400/20 hover:border-amber-400/60 hover:shadow-2xl hover:-translate-y-4 transition-all duration-500 text-center">
              <Image
                src="https://st2.depositphotos.com/10313122/45222/i/450/depositphotos_452223652-stock-photo-portrait-successful-young-african-businessman.jpg"
                alt="Dawit Lemma"
                width={400}
                height={400}
                className="w-28 h-28 rounded-full mx-auto mb-6 object-cover border-4 border-amber-400/50"
              ...
              <p className="text-gray-300 italic mb-6">
                "Exceptional results and creative flair! They turned our vision into reality with stunning designs and powerful campaigns."
              </p>
      ...
      {/* Contact Section - Attractive Layout */}
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-7xl mx-auto items-center">
            ...
            <div className="order-2 lg:order-1">
              <Image
                src="https://img.freepik.com/free-vector/contact-us-concept-landing-page_52683-21978.jpg"
                alt="Let's Connect - Contact Illustration"
                width={800}
                height={600}
                className="rounded-2xl shadow-2xl border-4 border-amber-400/30"
              />
            ...
            <div className="order-1 lg:order-2 bg-gray-900/70 backdrop-blur-md p-10 rounded-2xl border border-amber-400/30">
              ...
              <form className="space-y-6">
                <input
                  ...
                  className="w-full px-6 py-4 bg-gray-800/70 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-amber-400 focus:outline-none transition"
                  required
                />
                <input
                  type="email"
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-6 py-4 bg-gray-800/70 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-amber-400 focus:outline-none transition resize-none"
                  required
                ></textarea>
                <button
                  type="submit"
                  className="w-full bg-amber-400 text-gray-900 py-5 rounded-lg font-bold text-xl hover:bg-amber-300 transition shadow-xl transform hover:scale-105"
                >
                  Send Message
                </button>
              </form>
              ...
              <div className="mt-10 space-y-4 text-center text-gray-300">
                <p className="flex items-center justify-center gap-3">
                  <Mail className="w-6 h-6 text-amber-400" /> info@tesfamarketing.com
                </p>
                <p className="flex items-center justify-center gap-3">
                  <Phone className="w-6 h-6 text-amber-400" /> +251 911 234 567
                </p>
                <p className="flex items-center justify-center gap-3">
                  <MapPin className="w-6 h-6 text-amber-400" /> Addis Ababa, Ethiopia
                </p>
              </div>
            </div>
          </div>
